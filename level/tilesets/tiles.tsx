...
<tileset version="1.2" tiledversion="1.3.2" name="tiles" tilewidth="64" tileheight="64" tilecount="30" columns="10">
 <image source="../../image/SNAK-Tileset.png" width="640" height="192"/>
 <tile id="0" type="wall">
  <properties>
 ...
 <tile id="14" type="snake"/>
 <tile id="15" type="wall"/>
 <tile id="16" type="wall"/>
 <tile id="17" type="wall"/>
 <tile id="18" type="wall"/>
 <tile id="19" type="wall"/>
 <tile id="20" type="pellet">
  <properties>
   <property name="color" type="int" value="1"/>
  </properties>
 </tile>
 <tile id="21" type="pellet">
  <properties>
   <property name="color" type="int" value="2"/>
  </properties>
 </tile>
 <tile id="22" type="pellet">
  <properties>
   <property name="color" type="int" value="3"/>
  </properties>
 </tile>
 <tile id="23" type="pellet"/>
